...
import apigenerica.dao.LogDao;
import java.util.List;

/**
 * Capa de servicio para logs.
 *
 * Oculta el DAO y el Monitor al controlador REST. Aquí se centraliza cualquier
 * lógica de negocio sobre los logs (validaciones, paginación, filtrado
 * avanzado, etc.).
 *
...
public class LogService {
    ...
    // ---------------------------------------------------------------
    /**
     * Inicializa el DAO y arranca el monitor de cambios. Llamar UNA SOLA VEZ al
    ...
    /**
     * Detiene el monitor de cambios. Llamar al apagar la aplicación (shutdown
     * hook).
     */
    ...
    // ---------------------------------------------------------------
    /**
     * Devuelve todos los logs en orden descendente (más reciente primero). Cada
     * elemento es String[6]: {id, usuario, operacion, tabla, descripcion,
     * timestamp}
     *
     * @return
     */
    ...
    /**
     * Búsqueda simple: devuelve los logs donde cualquier campo contenga el
     * texto indicado (case-insensitive).
     *
     * @param filtro
     * @return
     */
    ...
    /**
     * Registra un log manualmente (útil para que la propia API REST audite sus
     * propias operaciones).
     *
    ...
    /**
     * Convierte la lista de String[] en una lista de LogEntry, más cómoda para
     * serializar a JSON con cualquier librería.
     *
     * @return
     */
    ...
    // ---------------------------------------------------------------
    /**
     * Representación de un registro de log lista para serializar. Compatible
     * con cualquier librería JSON (Gson, Jackson, etc.).
     */
