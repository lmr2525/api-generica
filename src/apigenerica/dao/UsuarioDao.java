...
/**
 * Operaciones CRUD para la tabla de usuarios de la aplicación erp_users,
 * almacenada en MySQL
 *
 * @author Grupo1
 */
public class UsuarioDao {
    ...
    /**
     * Consulta la base de datos para obtener rol de un usuario de la aplicación
     * a partir de su id
     *
     * @param id ID del usuario
     * @return Rol obtenido
     */
    public Integer obtenerRol(Long id) {
        String sql = "SELECT rol FROM `erp_users` WHERE id = ? AND u.activo = 1";
