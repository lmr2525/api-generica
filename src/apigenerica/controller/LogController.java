 ...
 *
 * Endpoints expuestos (todos requieren token JWT): GET /api/logs → todos los
 * logs (más reciente primero) GET /api/logs?q=texto → filtro por cualquier
 * campo POST /api/logs → registrar log manual
 *
...
public class LogController {
    ...
    /**
     * GET /api/logs Parámetro opcional: ?q=texto (filtra por usuario,
     * operación, tabla o descripción)
     *
     * @param ctx
     */
    ...
    /**
     * POST /api/logs Body JSON: { "usuario":"...", "operacion":"...",
     * "tabla":"...", "descripcion":"..." } Permite registrar un log manualmente
     * desde la propia API o desde un cliente externo.
     *
     * @param ctx
     */
